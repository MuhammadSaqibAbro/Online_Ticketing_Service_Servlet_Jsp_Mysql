...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM events WHERE name LIKE 'concert%' OR name LIKE 'Concert%'";
...
<head>
    ...
    <title>Available Concerts</title>
    <style>
        body { font-family: Arial, sans-serif; background-color: #102031; color: white; }
        .container { max-width: 800px; margin: 0 auto; padding: 20px; }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 10px; border: 1px solid #ccc; }
        th { background-color: #204060; color: white; }
        td { color: white; }
        .btn { padding: 10px 20px; background-color: #204060; color: white; border: none; cursor: pointer; }
        .btn:hover { background-color: #1a1a2e; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <table>
            ...
            %>
                <tr>
                    <td colspan="7">No concerts available.</td>
                </tr>
            <% 
            }
            %>
