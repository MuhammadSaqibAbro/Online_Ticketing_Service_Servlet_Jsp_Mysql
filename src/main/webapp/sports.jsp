...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM events WHERE name LIKE 'sports%' OR name LIKE 'Sports%'";
...
<head>
    ...
    <title>Available Sports Events</title>
    <style>
        body { 
...
<body>
    <div class="container">
        ...
        <table>
            ...
            %>
                <tr>
                    <td colspan="7">No sports events available.</td>
                </tr>
            <% 
            }
            %>
