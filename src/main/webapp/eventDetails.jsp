                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                <p>Seated Ticket: $<%= seatedPrice %></p>
                                <p>Standing Ticket: $<%= standingPrice %></p>
                                <a href='purchase.jsp?eventId=<%= eventId %>&ticketType=seated' class='purchase-button'>Purchase Seated Ticket</a>
                                <a href='purchase.jsp?eventId=<%= eventId %>&ticketType=standing' class='purchase-button'>Purchase Standing Ticket</a>
                                <%
                            } else {
