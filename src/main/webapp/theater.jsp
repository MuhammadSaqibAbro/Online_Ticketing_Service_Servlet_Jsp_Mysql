...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM events WHERE name LIKE 'theater%' OR name LIKE 'Theater%'";
...
<head>
    ...
    <title>Available Theater Shows</title>
    <style>
        body { 
...
<body>
    <div class="container">
        ...
        <table>
            ...
            %>
                <tr>
                    <td colspan="7">No theater shows available.</td>
                </tr>
            <% 
            }
            %>
