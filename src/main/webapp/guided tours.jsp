...
<%
    ...
    try {
        ...
        String sql = "SELECT * FROM events WHERE name LIKE 'guided tour%' OR name LIKE 'Guided Tour%'";
...
<head>
    ...
    <title>Available Guided Tours</title>
    <style>
        body { 
...
<body>
    <div class="container">
        ...
        <table>
            ...
            %>
                <tr>
                    <td colspan="7">No guided tours available.</td>
                </tr>
            <% 
            }
            %>
